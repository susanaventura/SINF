...
namespace OnlineStore.Controllers
{
    public class ProductsController : ApiController
    {
        ...
        public ProductListing Get([FromUri]string page = "1", [FromUri]string pageLength = "30", [FromUri]string codStore = "", [FromUri]string codCategory = "",
                [FromUri]string filterOnSale = "", [FromUri]string filterPoints = "", [FromUri]string sortDate = "", [FromUri]string searchString = "", [FromUri]string sortLastSold = "")
        {
            ...
            return Lib_Primavera.PriIntegration.ListProducts(indexStart, pageSize, codCategory, codStore, !filterOnSale.Equals(""), !filterPoints.Equals(""), !sortDate.Equals(""), searchString, !sortLastSold.Equals(""));
        }
